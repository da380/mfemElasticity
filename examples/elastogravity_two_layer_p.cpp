// Elastogravity problem for a liquid-solid (core-mantle) Earth model (parallel).
// Mesh: ../data/elastogravity_two_layer_2d.msh, made with
//     meshing/concentric_circles -r 0.5467-1.0-1.2 -s 0.1-0.2 -o 2 -ma 6 -out elastogravity_two_layer_2d.msh
// For 3d:
//     meshing/concentric_spheres -r 0.5467-1.0-1.2 -s 0.02-0.06 -o 2 -ma 10 -out elastogravity_two_layer_3d.msh
#include <cmath>
#include <mfem.hpp>
