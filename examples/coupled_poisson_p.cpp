// Parallel version of coupled_poisson.cpp: the same coupled Poisson pair on a
// submesh, solved monolithically with ParSubMeshMixedBilinearForm. See the
// serial file for the problem statement and the mesh recipe.
#include <cmath>
